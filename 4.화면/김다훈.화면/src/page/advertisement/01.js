                    ...
                    <div>
                        <main>
                            ...
                            <div className='border border-dark w-72 h-96 p-4'>
                                {/* 페이지 이동은 Link */}
                                <Link to='/selectAdvertisement' id='deleteLinkCss' >
                                ...
                                <div className='d-flex justify-content-end'>
                                    <Link to='/selectAdvertisement' className='d-block' >
                                        <a className='btn btn-primary btn-outline-warning mt-4 p-2 btn-sm' role='button' style={{ background: 'orange' }}> 자세히 </a>
                                    </Link>
                                </div>
                            </div>
                            <hr/>
                            <div className='border border-dark w-72 h-96 p-4'>
                                ...
                                <Link to='/selectAdvertisement' className='d-block' id='deleteLinkCss'>
                                    <div className='border h-96 mb-4 p-4 d-flex align-items-center justify-content-center advertisementImg'>
                                        식당이미지
                                    </div>
                                </Link>
                                <div className='border h-96 mb-4 p-4 text-start'>
