...
const AdminFixAnswer = ({children}) => {
    ...
    return (
        <AdminLayout>
            <Row className='border border-dark mx-2 my-5 fw-bold' style={{height:'35rem'}}>
                    ...
                    <Row>
                        <Form className='p-0'>
                            <Form.Group className="mb-3 mt-5" controlId="exampleForm.ControlTextarea1">
                                ...
                                <Form.Control as="textarea" rows={3} defaultValue={inquiry.answer}/>
                            </Form.Group>
                        </Form>
                    </Row>
                    <Row className='mt-4'>
                        <Col>
                            ...
                            <Button variant="warning" className='w-25 float-end ms-3' href="/adminAnswer">저장</Button>
                            <InquiryCheckModal btnName={'삭제'} btnCss={'float-end'} btnstyle={'5rem'} modalBody={'답변을 삭제하시겠습니까?'} completeBtn={'/adminAnswerDelComplete'}/>
                        </Col>
                    </Row>
                </Col>
            </Row>
